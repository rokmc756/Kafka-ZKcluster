...
# controller.quorum.bootstrap.servers={{ _ipaddr }}:9093
...
# listeners=PLAINTEXT://{{ _ipaddr }}:9092,CONTROLLER://{{ _ipaddr }}:9093
...
# advertised.listeners=PLAINTEXT://{{ _ipaddr }}:9092,CONTROLLER://{{ _ipaddr }}:9093
